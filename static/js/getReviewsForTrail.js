...
.then(reviews => {
    for (const review of reviews) {
        ...
        <div style="border-style:solid; border-color:black; color:black; text-align: center; background-color: white; border-radius: 15px; margin-bottom: 15px; padding: 10px;">
